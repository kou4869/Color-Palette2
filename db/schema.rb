...
ActiveRecord::Schema.define(version: 2023_03_13_075816) do
  ...
  create_table "adimins", force: :cascade do |t|
    ...
    t.index ["email"], name: "index_adimins_on_email", unique: true
    t.index ["reset_password_token"], name: "index_adimins_on_reset_password_token", unique: true
  end
